...
<html lang="en">
  <head>
    ...
    <!---- date piker css --->
    <link href="{{ asset('assets/datepiker/dist/css/bootstrap-datepicker.css') }}" rel="stylesheet">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Gestionnaire des contactes</a>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Liste des contacts
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Ajouter un contact</a>
                    </h4>
                </div>
    ...
    <script src="{{ asset('assets/bootstrap/js/ie10-viewport-bug-workaround.js') }}"></script>
     ...
     <script src="{{ asset('assets/datepiker/dist/js/bootstrap-datepicker.js') }}"></script>
    ...
    <script type="text/javascript">
      ...
      var table = $('#contact-table').DataTable({
                      ...
                      columns: [
                        ...
                        //{data: 'société_id', name: 'société_id'},
      ...
      function deleteData(id){
          ...
          swal({
              title: 'Tu est sure?',
              text: "Vous voulez vraiment supprimer ce contact ?",
              type: 'warning',
